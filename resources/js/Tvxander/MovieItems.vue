                ...
                <div class="tabs">
                    <ul class="tab-links">
                        ...
                        <li>
                            <a
                                href="#tab3-h2"
                                @click="discoverMovies('getTopRated')"
                            >
                                #Top rated
                            </a>
                        </li>
                        <li>
                            <a
                                href="#tab4-h2"
                                @click="discoverMovies('getUpcoming')"
                            >
                                #Upcoming</a
                            >
                        </li>
                        <li>
                            <a
                                href="#tab4-h2"
                                @click="discoverMovies('getNowPlaying')"
                            >
                                #Now Playing</a
                            >
                        </li>
                ...
                <div class="tabs">
                    <ul class="tab-links">
                        ...
                        <li>
                            <a
                                href="#tab25-h2"
                                @click="discoverTv('getAiringToday')"
                            >
                                #Airing Today</a
                            >
                        </li>
