                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link" href="/browse/discover/discoverMovies">Discover</a></li>
                        ...
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link" href="/browse/discover/discoverTv">Discover</a></li>
